...
# 1. Chessboard squares form a bipartite graph (can be divided into two sets - white and black squares)
# 2. Knight moves always alternate between white and black squares
# 3. The visualization shows:
#    - Left side: All white squares with their coordinates (e.g., A1)
#    - Right side: All black squares with their coordinates
#    - Lines show the knight's path alternating between the two sets
# 4. This demonstrates the Hamiltonian path through the bipartite graph
# -------------------------------------------------------------------------------------
import pygame
import sys
import time
...
# Constants
WIDTH, HEIGHT = 1300, 800  # Increased width to accommodate all squares
BOARD_SIZE = 8
SQUARE_SIZE = 70
...
GRAPH_LEFT = 40
GRAPH_NODE_SPACING = 40  #  spacing
GRAPH_NODE_SIZE = 15  #  Node sizes
...
def draw_knight(surface, x, y, size):
    knight_text = font.render("♘", True, BLACK)
